...
const CLI_FIXTURES: Fixture[] = [
	{ operation: "system.migrate", result: { from: 1, to: 2, applied: ["x"] }, invoke: (c) => runMigrationCli(["schema", "--json"], c) },
	{
		...
		result: { results: [{ ok: true, result: {} }] },
		invoke: (c) => runBatchCli(["--items-json", JSON.stringify([{ op: "tasks.list", input: {} }]), "--json"], c),
	},
	{
	...
	{ operation: "tasks.list_page", result: { items: artifactList }, invoke: (c) => runTaskCli(["page", "--json"], c) },
	...
	{ operation: "docs.scope", result: artifactScope, invoke: (c) => runDocsCli(["scope", "a1", "--json"], c) },
	{ operation: "docs.set_global", result: artifactScope, invoke: (c) => runDocsCli(["set-global", "a1", "--json"], c) },
	{ operation: "docs.add_project", result: artifactScope, invoke: (c) => runDocsCli(["add-project", "a1", "p1", "--json"], c) },
	{ operation: "docs.remove_project", result: artifactScope, invoke: (c) => runDocsCli(["remove-project", "a1", "p1", "--json"], c) },
	{
		operation: "docs.replace_projects",
		result: artifactScope,
	...
	{ operation: "notes.list_page", result: { items: artifactList }, invoke: (c) => runNoteCli(["page", "--json"], c) },
	...
	{ operation: "playbooks.invoke", result: { entryTaskId: "t1" }, invoke: (c) => runPlaybooksCli(["invoke", "a1", "--json"], c) },
	...
	{ operation: "playbooks.scope", result: artifactScope, invoke: (c) => runPlaybooksCli(["scope", "a1", "--json"], c) },
	{ operation: "playbooks.set_global", result: artifactScope, invoke: (c) => runPlaybooksCli(["set-global", "a1", "--json"], c) },
	{ operation: "playbooks.add_project", result: artifactScope, invoke: (c) => runPlaybooksCli(["add-project", "a1", "p1", "--json"], c) },
	{
		operation: "playbooks.remove_project",
		result: artifactScope,
		invoke: (c) => runPlaybooksCli(["remove-project", "a1", "p1", "--json"], c),
	},
	{
